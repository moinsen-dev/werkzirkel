/**
 * T-505 — Foerderprofil Briefing Night-Erinnerung (Quartalsende-Hinweis).
 *
 * Wird vom Auto-Pause-Cron als Vorwarnung verschickt, wenn das Foerderprofil
 * in absehbarer Zeit pausiert wird (z.B. weil die letzte Briefing Night-
 * Teilnahme drei Quartale her ist). Soll motivieren, eine bevorstehende
 * Briefing Night zu besuchen, bevor das Profil pausiert.
 *
 * Betreff: „Erinnerung: deine naechste Briefing Night im Werkzirkel"
 */
...
export interface FoerderprofilBedarfsschauErinnerungProps {
  organisation: string;
  /** Anzahl Monate seit letzter Briefing Night (gerundet). */
...
export const T505_BETREFF =
  'Erinnerung: deine naechste Briefing Night im Werkzirkel';
...
export function FoerderprofilBedarfsschauErinnerung(
  ...
  return (
    <Layout
      vorschau={`Dein Foerderprofil fuer ${organisation} braucht bald wieder eine Briefing Night-Teilnahme.`}
      appUrl={appUrl}
    >
      <Heading as="h1" style={{ fontSize: '20px', margin: '0 0 16px 0' }}>
        Komm zur naechsten Briefing Night
      </Heading>

      <Text style={{ margin: '0 0 16px 0' }}>
        Dein Foerderprofil fuer {organisation} war seit {monateOhneTeilnahme}{' '}
        Monaten auf keiner Briefing Night. Damit es weiter sichtbar bleibt,
        bitten wir dich, in den kommenden Wochen wieder dabei zu sein.
      </Text>

      <Text style={{ margin: '0 0 16px 0' }}>
        Briefing Nights finden in den Werkzirkel-Staedten regelmaessig statt
